...
import com.palantir.gradle.suppressibleerrorprone.modes.interferences.RemoveUnnecessarySuppressionsInterference;
...
public abstract class Modes {
    ...
    private final Set<ModeInterference> interferences = Set.of(
            ...
            new RemoveUnnecessarySuppressionsInterference(),
